...
#include <memory>
#include "../PostgraduateApp/userRegister.h"
...
QT_MOC_LITERAL(3, 23, 8), // "username"
QT_MOC_LITERAL(4, 32, 3) // "pwd"

    },
    "UserRegister\0sendInfo\0\0username\0pwd"
};
...
void UserRegister::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendInfo((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        default: ;
        }
    }
}
